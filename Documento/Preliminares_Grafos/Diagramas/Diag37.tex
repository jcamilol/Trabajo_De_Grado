...
\begin{tikzpicture}[
  ...
  \path[->, line width=1pt] (v1) edge[loop top, out=120, in=60, looseness=8] node[draw=none, fill=none, above] {$e_1$} (v1);
  \path[->, line width=1pt] (v1) edge[loop top, out=150, in=30, looseness=18] node[draw=none, fill=none, above] {$e_2$} (v1);
