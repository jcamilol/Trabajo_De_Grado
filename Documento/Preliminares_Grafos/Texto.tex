...
En este caso nótese que $uv$ y $vu$ hacen referencia a la misma arista, pues $uv=\left\lbrace u,v\right\rbrace=\left\lbrace v, u\right\rbrace=vu$. Este tipo de grafos en los cuales el orden de los vértices en la representación de la arista no es tenido en cuenta también son llamados \textit{grafos no dirigidos}.
