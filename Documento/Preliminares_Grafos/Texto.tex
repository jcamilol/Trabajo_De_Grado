...
\end{Ejm}
\begin{Ejm}
   Un ejemplo de grafo es aquel en el cual tanto el conjunto de vértices como el de aristas es vacío: $G=(\phi, \phi)$. A dicho grafo lo llamamos \textbf{grafo vacío} y lo representamos simplemente por $\phi$. 
\end{Ejm}
