...
\begin{Ejm}
   La función $\varphi:V(G)\to V(G'):v_i\mapsto w_i$ para $i=1,2$, es un homomorfismo biyectivo entre los Revisa grafos $G$ y $G'$ de la \Cref{fig:homomorfo_no_isomorfo} (vacíamente se tiene que $\varphi$ preserva la adyacencia entre vértices).
