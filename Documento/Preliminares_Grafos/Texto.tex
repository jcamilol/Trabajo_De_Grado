...
\begin{Def}
   Sean $G=(V,E)$ y $G'=(V',E')$ dos grafos. Decimos que $\varphi:V\to V'$ es un homomorfismo de $G$ en $G'$ si $uv\in E$ implica $\varphi(u)\varphi(v)\in E'$ para cualesquiera vértices $u,v\in V$.
\end{Def}
El hecho que $uv\in E$ implique $\varphi(u)\varphi(v)\in E'$ lo resumimos diciendo que $\varphi$ preserva la adyacencia entre vértices, puesto que $\varphi$ mapea vértices adyacentes en $E$ en vértices adyacentes en $E'$.
\end{comment}
\begin{Ejm}
   La función
   \begin{center}
   ...
   \hfill$
   \end{center}
   Es un homomorfismo de $G_1$ en $G'_1$, donde $G_1$ y $G'_1$ son los grafos que se muestran a continuación.
   \input{Preliminares_Grafos/Diagramas/Fig19.tex}
   Para verificar que $\varphi_1$ es un homomorfismo notemos que $\varphi_1$ preserva la adyacencia entre vértices de $G_1$:
   \begin{center}
   $\hfill
   \begin{array}{rcl}
      v_1v_2 \in E(G_1) &\text{ y }& \varphi_1(v_1)\varphi_1(v_2) = w_1w_2 \in E(G'_1) \\
      v_1v_3 \in E(G_1) &\text{ y }& \varphi_1(v_1)\varphi_1(v_3) = w_1w_3 \in E(G'_1) \\
      v_1v_4 \in E(G_1) &\text{ y }& \varphi_1(v_1)\varphi_1(v_4) = w_1w_2 \in E(G'_1) \\
      v_2v_3 \in E(G_1) &\text{ y }& \varphi_1(v_2)\varphi_1(v_3) = w_2w_3 \in E(G'_1) \\
      v_2v_5 \in E(G_1) &\text{ y }& \varphi_1(v_2)\varphi_1(v_5) = w_2w_1 \in E(G'_1) \\
      v_3v_4 \in E(G_1) &\text{ y }& \varphi_1(v_3)\varphi_1(v_4) = w_3w_2 \in E(G'_1)
   \end{array}
   \hfill$
   \end{center}
\end{Ejm}
