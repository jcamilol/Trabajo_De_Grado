...
\begin{Ejm}
   \phantom{o}\par
   \begin{itemize}
      \item La colección de intervalos abiertos $\{(a,b)\mid a,b\in \mathbb{R}; a<b\}$ es base para una topología sobre $\mathbb{R}$, llamada la \textbf{topología usual} de $\mathbb{R}$.
